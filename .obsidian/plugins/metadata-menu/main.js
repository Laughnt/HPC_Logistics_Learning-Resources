...
var FileClassDataviewTable = class {
  ...
  buildTable(tableContainer) {
    ...
    tableContainer.onscroll = (e) => {
      ...
      if (firstColl && firstFileLink) {
        ...
        if (window.matchMedia("(max-width: 400px)").matches) {
          if (position !== 0) {
            table2.addClass("scrolled");
            table2.querySelectorAll("tbody > tr > td:first-child").forEach((item) => {
    ...
    const table = tableContainer.querySelector(`#table-container-${this.view.tableId}`);
    const dvApi = (_a = this.plugin.app.plugins.plugins.dataview) == null ? void 0 : _a.api;
    if (dvApi) {
...
var FileClassViewManager = class extends import_obsidian27.Component {
  ...
  onunload() {
    ...
    (_b = (_a = this.fileClassView) == null ? void 0 : _a.tableView.fileClassDataviewTable.observer) == null ? void 0 : _b.disconnect();
  }
...
// main.ts
var MetadataMenu = class extends import_obsidian82.Plugin {
  constructor() {
    super(...arguments);
    this.presetFields = [];
...
------------------------------------------`,
    ...
    this.registerEvent(
      this.app.vault.on("create", (file) => {
        if (!this.fieldIndex.fileClassesName.size)
          return;
        if (file instanceof import_obsidian82.TFile && this.settings.chooseFileClassAtFileCreation) {
    ...
    this.registerEvent(
      this.app.workspace.on("metadata-menu:indexed", () => {
        ...
        const currentView = this.app.workspace.getActiveViewOfType(import_obsidian82.MarkdownView);
        if (currentView)
